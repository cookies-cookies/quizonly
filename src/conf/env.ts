...
export const deeptrainAppName = import.meta.env.VITE_DEEPTRAIN_APP || "quizonly";
...
export function setDocsUrl(url: string): void {
   ...
   */
  url = url.trim() || "https://docs.quizonly.net";
...
export function setBlobEndpoint(endpoint: string): void {
   ...
   */
  endpoint = endpoint.trim() || "https://blob.quizonly.net";
